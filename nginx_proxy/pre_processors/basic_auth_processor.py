...
def process_basic_auth(container: Container, environments: map, vhost_map: Dict[str, Dict[int, Host]]):
    def get_auth_map(credentials: str):
        auth_map = {}
    ...
    if len(auth_env):
        ...
        for basic_auth_host, keys in auth_list:
            ...
            elif basic_auth_host['host'] in vhost_map:
                port_map = vhost_map[basic_auth_host['host']]
